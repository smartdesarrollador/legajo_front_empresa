...
export function contratoOcacionalDocx(
  ...
  try {
    ...
    const introduccion = new Paragraph({
      children: [
        new TextRun({
          text: 'Conste por el presente documento, el Contrato Individual de Trabajo de naturaleza accidental bajo la modalidad de "Ocasional" que celebran, de conformidad con lo establecido por artículo 60 del Texto Único Ordenado del Decreto Legislativo 728 – Ley de Productividad y Competitividad Laboral aprobado por el Decreto Supremo N.º 003-97-TR, de una parte,\n\n',
        }),
      ],
    });
    ...
    console.error('Error en contratoOcacionalDocx:', error);
    throw error;
  }
}
