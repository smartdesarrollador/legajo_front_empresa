...
export function contratoInnominadoDocx(
  ...
  try {
    ...
    const introduccion = new Paragraph({
      children: [
        new TextRun({
          text: 'Conste por el presente documento, el Contrato modal a plazo fijo que celebran, de conformidad con lo establecido por el artículo 82 del Texto Único Ordenado del Decreto Legislativo 728 – Ley de Productividad y Competitividad Laboral aprobado por el Decreto Supremo N.º 003-97-TR, de una parte,\n\n',
        }),
      ],
    });
    ...
    const clausulas = [
      ...
      new Paragraph({
        children: [
          ...
          new TextRun({ text: '1 año', bold: true }),
    ...
    console.error('Error en contratoInnominadoDocx:', error);
    throw error;
  }
}
